...
# Temperature_input = st.text_input("Temperature (°C)", placeholder="Enter value here...")
...
#     except ValueError:
#         st.error("🚨 There is some error. Please check the inputs and enter valid numbers.")
